...
from mysite.models import Pubcater
from elasticsearch.client import IndicesClient
from django.conf import settings
#from labdemo.es_mappings import model_es_indices, es_mappings
from mysite.maps import es_mappings, model_es_indices
...
class Command(BaseCommand):
	...
	def push_db_to_index(self):
		data = [
			self.convert_for_bulk(s, 'create') for s in Pubcater.objects.all()[:1000]
			]
